...
public class UserHomePageUI {
    public static final String USER_REGISTER_LINK = "css=a[class='ico-register']";
    public static final String USER_LOGIN_LINK = "xpath=//a[@class='ico-login']";
    public static final String USER_MY_ACCOUNT_LINK_HEADER = "Xpath=//div[@class='header-links']//a[@class='ico-account']";
